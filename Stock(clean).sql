...
CREATE SEQUENCE SEQCALENDRIERINVENTAIRE START WITH 1 INCREMENT BY 1;
...
Create table Calendrierinventaire(
    idcalendrierinventaire VARCHAR2(100) PRIMARY KEY NOT NULL,
    datecalendrier timestamp,
    description NVARCHAR2(1000),
